...
import {
  FileDown, LayoutDashboard, Gavel, FileText, CreditCard, BarChart2,
  ShieldCheck, Settings, LogOut, Bell, HelpCircle, User, Scale,
  Search, History, ChevronLeft, ChevronRight, Eye,
} from 'lucide-react'
    ...
    <div className="min-h-screen bg-slate-100 flex flex-col">
      ...
      <header className="flex justify-between items-center w-full h-16 px-6 sticky top-0 bg-white border-b border-slate-200 z-40">
        ...
        <nav className="hidden md:flex gap-6">
          ...
          <a href="#" onClick={(e) => { e.preventDefault(); navigate('/audit-log/search') }} className="border-b-2 border-slate-900 text-slate-900 font-bold text-xs uppercase tracking-widest py-2 px-3">Audit Log</a>
        </nav>
        <TopNavActions>
