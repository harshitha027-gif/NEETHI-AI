...
import {
  ArrowLeft, RotateCw, Info, LayoutDashboard, Gavel, FileText,
  CreditCard, BarChart2, ShieldCheck, Settings, LogOut, Scale,
              ...
              return (
                <a
                  ...
                  className={`flex items-center gap-3 px-3 py-2 rounded text-sm font-semibold transition-all ${
                    active ? 'bg-slate-200 text-slate-900 border-l-4 border-slate-900' : 'text-slate-600 hover:bg-slate-100'
                  }`}
                >
